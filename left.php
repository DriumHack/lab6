				...
				<table border="0" width="90%" id="table1">
					...
					<tr>
						...
						<td width="35%"><select size="1" name="D1">
								<option <? if ($_POST['D1'] == 'мужской') echo 'selected'; else echo ''; ?>>мужской</option>
								<option <? if ($_POST['D1'] == 'женский') echo 'selected'; else echo ''; ?>>женский</option>
							</select></td>
					</tr>
					<tr>
						<td width="55%">Являетесь ли вы студентом/студенткой?</td>
						<td width="35%"><input type="radio" value="V1" name="R1" <? if ($_POST['R1'] == 'V1' || empty($_POST['R1'])) echo 'checked'; else echo ''; ?>>да
							<input type="radio" name="R1" value="V2" <? if ($_POST['R1'] == 'V2') echo 'checked'; else echo ''; ?>>нет
						</td>
					</tr>
					<tr>
						<td width="55%">Ваш <span lang="en-us">e-mail</span></td>
						<td width="35%"><input type="text" name="T6" size="20" value="<? echo $_POST['T6']; ?>"></td>
					</tr>
					<tr>
						<td width="55%">Получать рассылку с нашего сайта?</td>
						<td width="35%"><input type="checkbox" name="C1" value="ON" <? if (!empty($_POST['C1'])) echo 'checked'; echo ''; ?>></td>
					</tr>
				</table>
			</div>
